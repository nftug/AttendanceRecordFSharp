         ...
         Grid()
            ...
            .Children(
               StackPanel()
                  ...
                  .Children(
                     ...
                     |> _.Width(50.0)
                        .Height(50.0)
                        .IsEnabled(
                           ctx.SelectedDate |> R3.map ((<>) (Some DateTime.Today)) |> asBinding
                        ),
                     SymbolIconButton.create
                        { Symbol = Symbol.Calendar |> R3.ret
               ...
               StackPanel()
                  ...
                  .Column(2)
                  .Children(
                     SymbolIcon.create (Symbol.CalendarMonth |> R3.ret),
                     TextBlock()
